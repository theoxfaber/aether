        ...
        c.par_iter_mut().enumerate().for_each(|(idx, out)| {
            ...
            for block_idx in 0..blocks_per_row {
                ...
                for _j in (0..Q4K_BLOCK_SIZE).step_by(64) {
                    ...
                    let d_a1 =
                        half::f16::from_le_bytes([a_quant[ao_lo], a_quant[ao_lo + 1]]).to_f32();
                    let d_a2 =
                        half::f16::from_le_bytes([a_quant[ao_hi], a_quant[ao_hi + 1]]).to_f32();
                    ...
                    for _j in (0..Q4K_BLOCK_SIZE).step_by(64) {
                        ...
                        unsafe {
                            ...
                            for row_a in 0..m {
                                ...
                                let act_lo0 =
                                    vld1q_s8(a_quant.as_ptr().add(ao_lo + 2) as *const i8);
                                let act_lo1 =
                                    vld1q_s8(a_quant.as_ptr().add(ao_lo + 2 + 16) as *const i8);

                                let act_hi0 =
                                    vld1q_s8(a_quant.as_ptr().add(ao_hi + 2) as *const i8);
                                let act_hi1 =
                    ...
                    for half in 0..2 {
                        ...
                        for l in (0..32).step_by(16) {
                            ...
                            acc_v = vmlaq_f32(
                                acc_v,
                                vmulq_f32(q1_1, ds1),
                                vld1q_f32(ap_stripe1.add(4)),
                            );
                            acc_v = vmlaq_f32(
                                acc_v,
                                vmulq_f32(q1_2, ds1),
                                vld1q_f32(ap_stripe1.add(8)),
                            );
                            acc_v = vmlaq_f32(
                                acc_v,
                                vmulq_f32(q1_3, ds1),
                                vld1q_f32(ap_stripe1.add(12)),
                            );
                            ...
                            acc_v = vmlaq_f32(
                                acc_v,
                                vmulq_f32(q2_1, ds2),
                                vld1q_f32(ap_stripe2.add(4)),
                            );
                            acc_v = vmlaq_f32(
                                acc_v,
                                vmulq_f32(q2_2, ds2),
                                vld1q_f32(ap_stripe2.add(8)),
                            );
                            acc_v = vmlaq_f32(
                                acc_v,
                                vmulq_f32(q2_3, ds2),
                                vld1q_f32(ap_stripe2.add(12)),
                            );
                            ...
                            acc_v = vmlaq_f32(
                                acc_v,
                                vmulq_f32(q3_1, ds3),
                                vld1q_f32(ap_stripe3.add(4)),
                            );
                            acc_v = vmlaq_f32(
                                acc_v,
                                vmulq_f32(q3_2, ds3),
                                vld1q_f32(ap_stripe3.add(8)),
                            );
                            acc_v = vmlaq_f32(
                                acc_v,
                                vmulq_f32(q3_3, ds3),
                                vld1q_f32(ap_stripe3.add(12)),
                            );
                            ...
                            acc_v = vmlaq_f32(
                                acc_v,
                                vmulq_f32(q4_1, ds4),
                                vld1q_f32(ap_stripe4.add(4)),
                            );
                            acc_v = vmlaq_f32(
                                acc_v,
                                vmulq_f32(q4_2, ds4),
                                vld1q_f32(ap_stripe4.add(8)),
                            );
                            acc_v = vmlaq_f32(
                                acc_v,
                                vmulq_f32(q4_3, ds4),
                                vld1q_f32(ap_stripe4.add(12)),
                            );
                        }
                    }
                    ...
                    unsafe {
                        for half in 0..2 {
                            ...
                            for l in (0..32).step_by(16) {
                                ...
                                let v_ql_l = vld1q_s8(ql.as_ptr().add(ql_off + l) as *const i8);
                                let v_ql_l32 =
                                    vld1q_s8(ql.as_ptr().add(ql_off + l + 32) as *const i8);
                                let v_qh_l = vld1q_s8(qh.as_ptr().add(qh_off + l) as *const i8);
                    ...
                    unsafe {
                        for half in 0..2 {
                            ...
                            for l in (0..32).step_by(16) {
                                ...
                                for row_a in 0..m {
                                    let ao1 =
                                        (row_a * blocks_per_row * 8 + b_base) * Q8_BLOCK_BYTES;
                                    let ao2 =
                                    ...
                                    let act1 =
                                        vld1q_s8(a_quant.as_ptr().add(ao1 + 2 + l) as *const i8);
                                    let act2 =
                                        vld1q_s8(a_quant.as_ptr().add(ao2 + 2 + l) as *const i8);
                                    let act3 =
                                        vld1q_s8(a_quant.as_ptr().add(ao3 + 2 + l) as *const i8);
                                    let act4 =
                                        vld1q_s8(a_quant.as_ptr().add(ao4 + 2 + l) as *const i8);
                ...
                for block_idx in 0..blocks_per_row {
                    ...
                    unsafe {
                        for is in (0..8).step_by(2) {
                            ...
                            for l in (0..32).step_by(16) {
                                let v_qs_lo =
                                    vld1q_s8(qs.as_ptr().add(is / 2 * 32 + l) as *const i8);
                                ...
                                let ql_odd = vreinterpretq_s8_u8(vshrq_n_u8(
                                    vreinterpretq_u8_s8(v_qs_lo),
                                    4,
                                ));
                                ...
                                let qh_comb_odd =
                                    vcombine_u8(vget_low_u8(qh_lo_bits_odd), vget_low_u8(qh_hi_bits_odd));
                                ...
                                for row_a in 0..m {
                                    ...
                                    let act_lo = vld1q_s8(
                                        a_quant.as_ptr().add(base_lo + 2 + l) as *const i8
                                    );
                                    let act_hi = vld1q_s8(
                                        a_quant.as_ptr().add(base_hi + 2 + l) as *const i8
                                    );
                                    ...
                                    results[row_a] += d_a_lo
                                        * (d1 * (vaddvq_s32(dot_lo) as f32) - m1 * sum_act_lo);
                                    results[row_a] += d_a_hi
                                        * (d2 * (vaddvq_s32(dot_hi) as f32) - m2 * sum_act_hi);
                                }
                            }
                        }
                    }
                ...
                for block_idx in 0..blocks_per_row {
                    ...
                    unsafe {
                        ...
                        for row_a in 0..m {
                            ...
                            let d_a =
                                half::f16::from_le_bytes([a_quant[ao], a_quant[ao + 1]]).to_f32();
                            let act0 = vld1q_s8(a_quant.as_ptr().add(ao + 2) as *const i8);
                            let act1 = vld1q_s8(a_quant.as_ptr().add(ao + 2 + 16) as *const i8);
        ...
        c.par_iter_mut().enumerate().for_each(|(idx, out)| {
            ...
            unsafe {
                ...
                while i + 8 <= k {
                    ...
                    let b0 =
                        half::f16::from_bits(u16::from_le_bytes([b_bytes[bo], b_bytes[bo + 1]]))
                            .to_f32();
                    let b1 = half::f16::from_bits(u16::from_le_bytes([
                        b_bytes[bo + 2],
                        b_bytes[bo + 3],
                    ]))
                    .to_f32();
                    let b2 = half::f16::from_bits(u16::from_le_bytes([
                        b_bytes[bo + 4],
                        b_bytes[bo + 5],
                    ]))
                    .to_f32();
                    let b3 = half::f16::from_bits(u16::from_le_bytes([
                        b_bytes[bo + 6],
                        b_bytes[bo + 7],
                    ]))
                    .to_f32();
                    let b4 = half::f16::from_bits(u16::from_le_bytes([
                        b_bytes[bo + 8],
                        b_bytes[bo + 9],
                    ]))
                    .to_f32();
                    let b5 = half::f16::from_bits(u16::from_le_bytes([
                        b_bytes[bo + 10],
                        b_bytes[bo + 11],
                    ]))
                    .to_f32();
                    let b6 = half::f16::from_bits(u16::from_le_bytes([
                        b_bytes[bo + 12],
                        b_bytes[bo + 13],
                    ]))
                    .to_f32();
                    let b7 = half::f16::from_bits(u16::from_le_bytes([
                        b_bytes[bo + 14],
                        b_bytes[bo + 15],
                    ]))
                    .to_f32();
