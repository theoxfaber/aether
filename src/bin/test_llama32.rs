...
fn main() -> Result<(), Error> {
    ...
    // greedy
    let mut next_tok = sample(&last_logits, 0.0, 1.0, &token_ids, 1.0);
    eprintln!(
        "First token: {} '{}'",
        next_tok,
    ...
    for step in 0..29 {
        ...
        next_tok = sample(&last_logits, 0.0, 1.0, &token_ids, 1.0);
    ...
    let mut next_tok2 = sample(&last_logits2, 0.8, 0.9, &token_ids2, 1.0);
    ...
    for step in 0..49 {
        ...
        next_tok2 = sample(&last_logits2, 0.8, 0.9, &token_ids2, 1.0);
