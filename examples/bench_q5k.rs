use aether::quant::matmul::matmul_q5_k;
...
fn main() {
    ...
    for &(name, m, n, k) in &shapes {
        ...
        for _ in 0..warmup {
            matmul_q5_k(&a, &b_quant, m, n, k, &mut c);
        }
        ...
        println!("  Sample c[0] = {:.4}", c[0]);
    }

    println!("\n═══ Batched: 4x4096x14336 ═══");
    let (m, n, k) = (4usize, 4096usize, 14336usize);
    let a_size = m * k;
    let b_quant_size = n * k * 176 / 256;
    let c_size = m * n;
